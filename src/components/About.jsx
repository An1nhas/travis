      ...
      <div className="container">
        ...
        <Row>
          <Col md={4}>
            ...
            <h1 className="sub_title">Collaborate for communication tools</h1>
          ...
          <Col md={4}>
            ...
            <h1 className="sub_title">Compile digital corpora</h1>
          ...
          <Col md={4}>
            ...
            <h1 className="sub_title">Apply machine learning technology</h1>
